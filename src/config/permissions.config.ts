export const permissions = {
  ...
  "website.edit_draft": ["Publicity Coordinator", "Technical Administrator"],
  "website.publish": ["Publicity Coordinator", "President / Executive", "General Secretary", "Technical Administrator"],
